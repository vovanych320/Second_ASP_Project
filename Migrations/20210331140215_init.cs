        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PodcastAuthor = table.Column<string>(nullable: true),
                    PodcastDuration = table.Column<string>(nullable: true),
                    PodcastPremierDate = table.Column<DateTime>(nullable: false),
                    PodcastTopic = table.Column<string>(nullable: true),
                    PodcastDescription = table.Column<string>(nullable: true),
                    PodcasrListenedAmount = table.Column<string>(nullable: true),
                    PodcastClients = table.Column<string>(nullable: true),
                    PodcastAudience = table.Column<string>(nullable: true),
                    PodcastPrice = table.Column<double>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { "44546e06-8719-4ad8-b88a-f271ae9d6eab", "2038e0ec-3b3d-45e5-8f7c-b29a8451a2b8", "admin", "ADMIN" });

            migrationBuilder.InsertData(
                table: "AspNetUsers",
                columns: new[] { "Id", "AccessFailedCount", "ConcurrencyStamp", "Email", "EmailConfirmed", "LockoutEnabled", "LockoutEnd", "NormalizedEmail", "NormalizedUserName", "PasswordHash", "PhoneNumber", "PhoneNumberConfirmed", "SecurityStamp", "TwoFactorEnabled", "UserName" },
                values: new object[] { "3b62472e-4f66-49fa-a20f-e7685b9565d8", 0, "e46c4f08-8bc8-4f01-bb56-213fb114db1d", "my@email.com", true, false, null, "MY@EMAIL.COM", "ADMIN", "AQAAAAEAACcQAAAAENMMfA2m+TnYcwdMA5CUIbDpUK4G/nbi+4S+Ym4yAWyYA6DtJx53/jQRJSlyoQ5oZQ==", null, false, "", false, "admin" });
